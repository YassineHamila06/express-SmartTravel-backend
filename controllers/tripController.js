...
const createTrip = asyncHandler(async (req, res) => {
  const { destination, price, description, debutDate, endDate, tripType, reduction } = req.body;
...
const updateTrip = asyncHandler(async (req, res) => {
  ...
  if (req.body.reduction || req.body.price) {
    const reduction = req.body.reduction !== undefined ? req.body.reduction : trip.reduction;
